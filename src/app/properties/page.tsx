...
const PropertiesPage = () => {
	...
	const filteredProperties = properties.filter((property) => {
		...
		if (priceRange !== "all") {
			...
			else if (priceRange === "20000-35000")
				matchesPrice = price > 20000 && price <= 35000;
			else if (priceRange === "35000-50000")
							...
							<div className="p-6">
								...
								<div className="flex items-center justify-between">
									...
									<button
										...
										className="flex items-center space-x-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-4 py-2 rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 font-medium"
									>
